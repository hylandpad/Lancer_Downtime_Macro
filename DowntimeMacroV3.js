                                ...
                                <div style="margin-bottom:1rem">
                                    ...
                                    <div style="min-height: 100px; border: 5px dashed cadetblue; background-color: #5f9ea070; padding:.5rem; margin-top: .5rem;">
                                        ...
                                        <div style="text-align: right;">
                                            ...
                                            <textarea placeholder="Precision circumstantial modification coefficients. Add notes for ingestion by Evaluatory" style="display:inline; width: 100%; height: 50px; background-color: transparent; border: 1px #00000085 solid; border-radius: 3px;margin-top:5px;" type="text" id="flatOverrideNote"></textarea>
                                            ...
                                            <textarea placeholder="Precision circumstantial modification coefficients, adjusted for causal free radicals." style="display:inline; width: 100%; height: 50px; background-color: transparent; border: 1px #00000085 solid; border-radius: 3px;" type="text" id="modifierNote"></textarea>
                                            ...
                                            <textarea placeholder="Full override, bypasses Probability matrices. Precognitive bandwidth may exceed administrative NHP allotment. Use sparingly." style="display:inline; width: 100%; height: 50px; background-color: transparent; border: 1px #00000085 solid; border-radius: 3px;margin-top:5px;" type="text" id="staticOverrideNote"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
